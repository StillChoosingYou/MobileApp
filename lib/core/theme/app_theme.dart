...
/// PGPC's exact Pantone/hex spec wasn't confirmed from public sources, so
/// this is a deliberate professional-academic placeholder: royal blue for
/// trust and heritage, antique gold for the ceremonial/seal feel most PH
/// state colleges use. Everything else in the theme derives from these two
/// seeds via [ColorScheme.fromSeed] — replace these two constants with the
/// college's real Pantone-to-hex values (from the letterhead or seal) and
/// the whole app re-themes correctly.
class AppColors {
  AppColors._();

  static const Color royalBlueSeed = Color(0xFF0E3A65);
  static const Color goldSeed = Color(0xFFC9A227);
  static const Color goldAccentDark = Color(0xFFE4BE4A);
